...
1. **Intent → Maker Tool, zero plugin knowledge.** Typing "nameplate" or tapping the chip resolves to the Nameplate Maker automatically; the alternatives shown are other *maker tools* (QR Sign Maker, Light Box Maker), never plugin IDs.
